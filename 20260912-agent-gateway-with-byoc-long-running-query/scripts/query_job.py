...
def query_payload(marker: str, delay_seconds: int) -> str:
    ...
    from byoc_runtime.models import QueryJobInput

    validated = QueryJobInput(verification_id=marker, delay_seconds=delay_seconds)
...
def main() -> None:
    ...
    QueryJobInput(verification_id="query-job-marker", delay_seconds=args.delay_seconds)
